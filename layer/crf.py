...
class CRF(nn.Module):
    ...
    def _calculate_PZ(self, feats, mask):
        ...
        for idx, cur_values in seq_iter:
            ...
            #masked_cur_partition = cur_partition.masked_select(mask_idx) zyq
            masked_cur_partition = cur_partition.masked_select(mask_idx.bool())
            ## let mask_idx broadcastable, to disable warning
            mask_idx = mask_idx.contiguous().view(batch_size, tag_size, 1)

            ## replace the partition where the maskvalue=1, other partition value keeps the same
            #partition.masked_scatter_(mask_idx, masked_cur_partition) zyq
    ...
    def _viterbi_decode(self, feats, mask):
        ...
        for idx, cur_values in seq_iter:
            ...
            #cur_bp.masked_fill_(mask[idx].view(batch_size, 1).expand(batch_size, tag_size), 0) zyq
    ...
    def _score_sentence(self, scores, mask, tags):
        ...
        #tg_energy = tg_energy.masked_select(mask.transpose(1, 0)) zyq
